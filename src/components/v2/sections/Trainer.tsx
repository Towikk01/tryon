        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            <p className="mt-7 max-w-lg text-lg leading-relaxed text-ink-soft">
              ...
              тренер з 12+ роками практичного досвіду. Проведення персональних та
              групових тренувань, поєднуючи сучасні методики силового,
              функціонального тренінгу, TRX і Pilates. Індивідуальний підбір
              навантаження для кожного клієнта незалежно від віку, рівня
              підготовки чи фізичних особливостей.
            </p>
